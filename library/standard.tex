...
\chapter{Parsing}
This chapter covers how source code files are translated into the compiler's \emph{abstract syntax tree} \index{abstract syntax tree|see {AST}} (AST) \index{AST} representation of the program.

\section{Source Code File Formats}
To facilitate literate programming, Likely recognizes several source code file formats from their file extensions:
...
\item[.tex]  - \LaTeX\ file, source code is extracted from \texttt{likely} environment.
\end{description}
