...
\section{Matrix I/O}
\begin{likely}
read   := (-> return-type (extern return-type "likely_read" (string file-type type-type)))
...
import := (-> file ((read text) file guess text).data.(import-string file.guess-file-type))
\end{likely}
