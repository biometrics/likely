...
\chapter{Parsing}
This chapter covers how source code is translated into the compiler's \emph{abstract syntax tree} (AST).

\section{Lexical Analysis}
Source code is first converted into a sequence of tokens by applying the following rules:
