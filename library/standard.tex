...
\item{If both operands are integers and one operand is \pindex{signed}, the output is \pindex{signed}.}
\item{If one operand is \pindex{saturated}, the output is \pindex{saturated}.}
\end{enumerate}
...
\subsection{(\textless\textless\ $x$ $n$)}
...
\subsection{(\textgreater\textgreater\ $x$ $n$)}
