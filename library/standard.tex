...
\subsection{(\# $name$)}
Creates a \dindex{label} statement in the code.

\subsection{(? $condition$ $then$ $else$)}
Creates an \dindex{if} statement in the code.
