...
guess-file-type-t := (extern file-type-t "likely_guess_file_type" string-t)
\end{likely}
...
\section{Import}
\begin{likely}
import-string-t := (-> (source-code source-type) (lex-and-parse source-code source-type).(eval this null null))
import := (-> file ((read text) file guess text).data.(import-string-t file.guess-file-type-t))
\end{likely}
