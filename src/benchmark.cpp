...
class fmaTest : public Test {
    const char *function() const { return "a:-> { dst := a.imitate (=> (dst a) (+ (* a.f (a.type 2)) (a.type 3))) }"; }
...
class thresholdTest : public Test {
    const char *function() const { return "a:-> { dst := a.imitate (=> (dst a) (a.type (threshold-binary a 127 1))) }"; }
