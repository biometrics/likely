...
struct Expression
{
    ...
    virtual Expr evaluate(ExpressionBuilder &expressionBuilder, const vector<Expr> &args) const = 0;
};
...
struct Immediate : public Expr
{
    ...
    private:
        ...
        Expr evaluate(ExpressionBuilder &expressionBuilder, const vector<Expr> &args) const
        {
