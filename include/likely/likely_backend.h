...
// Compilation
typedef likely_mutable (*likely_function)(likely_matrix, ...);
typedef likely_mutable (*likely_function_n)(likely_matrix*);
...
// Evaluation
LIKELY_EXPORT likely_mutable likely_eval(likely_ast ast, likely_env env);
