...
LIKELY_EXPORT void likely_write_bitcode(likely_ir ir, const char *symbol_name, likely_type *types, likely_arity n, const char *file_name); // Does _not_ take ownership of ir
