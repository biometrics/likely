...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk2({ %f32XY*, %u8XY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %f32XY*, %u8XY* }, { %f32XY*, %u8XY* }* %0, i64 0, i32 0
  %4 = load %f32XY*, %f32XY** %3, align 8
  %5 = getelementptr inbounds { %f32XY*, %u8XY* }, { %f32XY*, %u8XY* }* %0, i64 0, i32 1
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %36 = alloca { %f32XY*, %u8XY* }, align 8
  %37 = bitcast { %f32XY*, %u8XY* }* %36 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %37, align 8
  %38 = getelementptr inbounds { %f32XY*, %u8XY* }, { %f32XY*, %u8XY* }* %36, i64 0, i32 1
  store %u8XY* %0, %u8XY** %38, align 8
  %39 = bitcast { %f32XY*, %u8XY* }* %36 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %u8XY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %39, i64 %35)
