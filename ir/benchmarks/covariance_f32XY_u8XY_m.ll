...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk2({ %u8XY*, %u8XY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %u8XY*, %u8XY* }, { %u8XY*, %u8XY* }* %0, i64 0, i32 0
  %4 = load %u8XY*, %u8XY** %3, align 8
  %5 = getelementptr inbounds { %u8XY*, %u8XY* }, { %u8XY*, %u8XY* }* %0, i64 0, i32 1
  ...
  %13 = getelementptr inbounds %u8XY, %u8XY* %6, i64 0, i32 6, i64 0
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %20 = getelementptr %u8XY, %u8XY* %6, i64 0, i32 6, i64 %19
  %21 = load i8, i8* %20, align 1, !llvm.mem.parallel_loop_access !3
  %22 = add nuw nsw i64 %x, %18
  %23 = getelementptr %u8XY, %u8XY* %4, i64 0, i32 6, i64 %22
  store i8 %21, i8* %23, align 1, !llvm.mem.parallel_loop_access !3
  %x_increment = add nuw nsw i64 %x, 1
...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk3({ %u8XY*, %f32X* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %u8XY*, %f32X* }, { %u8XY*, %f32X* }* %0, i64 0, i32 0
  %4 = load %u8XY*, %u8XY** %3, align 8
  %5 = getelementptr inbounds { %u8XY*, %f32X* }, { %u8XY*, %f32X* }* %0, i64 0, i32 1
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %18 = getelementptr %u8XY, %u8XY* %4, i64 0, i32 6, i64 %17
  %19 = load i8, i8* %18, align 1, !llvm.mem.parallel_loop_access !4
  %20 = getelementptr %f32X, %f32X* %6, i64 0, i32 6, i64 %x
  %21 = load float, float* %20, align 4, !llvm.mem.parallel_loop_access !4
  %22 = uitofp i8 %19 to float
  %23 = fsub fast float %22, %21
  %24 = fptoui float %23 to i8
  store i8 %24, i8* %18, align 1, !llvm.mem.parallel_loop_access !4
  %x_increment = add nuw nsw i64 %x, 1
...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk4({ %u8XY*, %u8XY*, i32 }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %u8XY*, %u8XY*, i32 }, { %u8XY*, %u8XY*, i32 }* %0, i64 0, i32 0
  %4 = load %u8XY*, %u8XY** %3, align 8
  %5 = getelementptr inbounds { %u8XY*, %u8XY*, i32 }, { %u8XY*, %u8XY*, i32 }* %0, i64 0, i32 1
  %6 = load %u8XY*, %u8XY** %5, align 8
  %7 = getelementptr inbounds { %u8XY*, %u8XY*, i32 }, { %u8XY*, %u8XY*, i32 }* %0, i64 0, i32 2
  ...
  %10 = getelementptr inbounds %u8XY, %u8XY* %4, i64 0, i32 6, i64 0
...
true_entry3:                                      ; preds = %loop.preheader, %true_entry3
  ...
  %27 = load i8, i8* %26, align 1, !llvm.mem.parallel_loop_access !5
  %28 = uitofp i8 %27 to double
  %29 = add nuw nsw i64 %24, %y
  %30 = getelementptr %u8XY, %u8XY* %6, i64 0, i32 6, i64 %29
  %31 = load i8, i8* %30, align 1, !llvm.mem.parallel_loop_access !5
...
exit4:                                            ; preds = %true_entry3, %loop.preheader
  ...
  %38 = getelementptr %u8XY, %u8XY* %4, i64 0, i32 6, i64 %37
  %39 = fptoui double %.lcssa to i8
  store i8 %39, i8* %38, align 1, !llvm.mem.parallel_loop_access !5
  %40 = mul nuw nsw i64 %x, %dst_y_step
  %41 = add nuw nsw i64 %40, %y
  %42 = getelementptr %u8XY, %u8XY* %4, i64 0, i32 6, i64 %41
  store i8 %39, i8* %42, align 1, !llvm.mem.parallel_loop_access !5
  br label %Flow6
}
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %34 = call %u0CXYT* @likely_new(i32 24584, i32 1, i32 %columns7, i32 %rows8, i32 1, i8* null)
  %35 = zext i32 %rows8 to i64
  %36 = alloca { %u8XY*, %u8XY* }, align 8
  %37 = bitcast { %u8XY*, %u8XY* }* %36 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %37, align 8
  %38 = getelementptr inbounds { %u8XY*, %u8XY* }, { %u8XY*, %u8XY* }* %36, i64 0, i32 1
  store %u8XY* %0, %u8XY** %38, align 8
  %39 = bitcast { %u8XY*, %u8XY* }* %36 to i8*
  call void @likely_fork(i8* bitcast (void ({ %u8XY*, %u8XY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %39, i64 %35)
  %40 = alloca { %u8XY*, %f32X* }, align 8
  %41 = bitcast { %u8XY*, %f32X* }* %40 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %41, align 8
  %42 = getelementptr inbounds { %u8XY*, %f32X* }, { %u8XY*, %f32X* }* %40, i64 0, i32 1
  %43 = bitcast %f32X** %42 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %43, align 8
  %44 = bitcast { %u8XY*, %f32X* }* %40 to i8*
  call void @likely_fork(i8* bitcast (void ({ %u8XY*, %f32X* }*, i64, i64)* @covariance_tmp_thunk3 to i8*), i8* %44, i64 %35)
  %45 = call %u0CXYT* @likely_new(i32 24584, i32 1, i32 %columns7, i32 %columns7, i32 1, i8* null)
  %dst = bitcast %u0CXYT* %45 to %u8XY*
  %46 = zext i32 %columns7 to i64
  %47 = alloca { %u8XY*, %u8XY*, i32 }, align 8
  %48 = bitcast { %u8XY*, %u8XY*, i32 }* %47 to %u0CXYT**
  store %u0CXYT* %45, %u0CXYT** %48, align 8
  %49 = getelementptr inbounds { %u8XY*, %u8XY*, i32 }, { %u8XY*, %u8XY*, i32 }* %47, i64 0, i32 1
  %50 = bitcast %u8XY** %49 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %50, align 8
  %51 = getelementptr inbounds { %u8XY*, %u8XY*, i32 }, { %u8XY*, %u8XY*, i32 }* %47, i64 0, i32 2
  store i32 %rows8, i32* %51, align 8
  %52 = bitcast { %u8XY*, %u8XY*, i32 }* %47 to i8*
  call void @likely_fork(i8* bitcast (void ({ %u8XY*, %u8XY*, i32 }*, i64, i64)* @covariance_tmp_thunk4 to i8*), i8* %52, i64 %46)
