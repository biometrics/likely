...
y_exit:                                           ; preds = %x_exit
  ...
  %33 = alloca { %f32XY*, %u8XY*, %f32X* }, align 8
  %34 = bitcast { %f32XY*, %u8XY*, %f32X* }* %33 to %u0CXYT**
  store %u0CXYT* %31, %u0CXYT** %34, align 8
  %35 = getelementptr inbounds { %f32XY*, %u8XY*, %f32X* }, { %f32XY*, %u8XY*, %f32X* }* %33, i64 0, i32 1
  store %u8XY* %0, %u8XY** %35, align 8
  %36 = getelementptr inbounds { %f32XY*, %u8XY*, %f32X* }, { %f32XY*, %u8XY*, %f32X* }* %33, i64 0, i32 2
  %37 = bitcast %f32X** %36 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %37, align 8
  %38 = bitcast { %f32XY*, %u8XY*, %f32X* }* %33 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %u8XY*, %f32X* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %38, i64 %32)
