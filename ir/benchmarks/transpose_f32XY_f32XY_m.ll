...
define private void @transpose_tmp_thunk0({ %f32Matrix*, %f32Matrix* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
entry.split:                                      ; preds = %entry
  ...
  %7 = getelementptr inbounds %f32Matrix, %f32Matrix* %6, i64 0, i32 4
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  store float %13, float* %15, align 4, !llvm.mem.parallel_loop_access !1
...
define noalias %f32Matrix* @transpose(%f32Matrix* noalias nocapture) #2 {
entry:
  br label %entry.split
...
entry.split:                                      ; preds = %entry
  ...
  %3 = call %u0Matrix* @likely_new(i32 24864, i32 1, i32 %rows, i32 %columns, i32 1, i8* null)
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix* }*, i64, i64)* @transpose_tmp_thunk0 to i8*), i8* %8, i64 %4) #2
  ret %f32Matrix* %dst
}
