...
y_exit:                                           ; preds = %exit
  %12 = bitcast %u32Matrix* %0 to i8*
  %13 = call i8* @likely_retain_mat(i8* %12) #1
  %14 = bitcast i8* %13 to %u32Matrix*
  ret %u32Matrix* %14
...
true_entry4:                                      ; preds = %true_entry, %true_entry4
  ...
  %20 = getelementptr %u32Matrix, %u32Matrix* %0, i64 0, i32 6, i64 %19
...
true_entry8:                                      ; preds = %exit5
  ...
  %27 = getelementptr %u32Matrix, %u32Matrix* %0, i64 0, i32 6, i64 %26
