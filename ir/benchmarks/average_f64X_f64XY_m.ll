...
entry:
  ...
  %3 = bitcast %u0Matrix* %2 to %f64Matrix*
  %4 = getelementptr inbounds %f64Matrix, %f64Matrix* %0, i64 0, i32 4
  %rows = load i32, i32* %4, align 4, !range !2
  %5 = zext i32 %columns to i64
  %6 = alloca { %f64Matrix*, i32 }, align 8
  %7 = bitcast { %f64Matrix*, i32 }* %6 to %u0Matrix**
  store %u0Matrix* %2, %u0Matrix** %7, align 8
  %8 = getelementptr inbounds { %f64Matrix*, i32 }, { %f64Matrix*, i32 }* %6, i64 0, i32 1
  store i32 0, i32* %8, align 8
  %9 = bitcast { %f64Matrix*, i32 }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, i32 }*, i64, i64)* @average_tmp_thunk0 to i8*), i8* %9, i64 %5) #3
  %10 = zext i32 %rows to i64
  %11 = getelementptr inbounds %u0Matrix, %u0Matrix* %2, i64 1
  %12 = bitcast %u0Matrix* %11 to double*
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %21 = getelementptr double, double* %12, i64 %x
...
true_entry:                                       ; preds = %y_exit
  ...
  %30 = alloca { %f64Matrix*, double }, align 8
  %31 = bitcast { %f64Matrix*, double }* %30 to %u0Matrix**
  store %u0Matrix* %2, %u0Matrix** %31, align 8
  %32 = getelementptr inbounds { %f64Matrix*, double }, { %f64Matrix*, double }* %30, i64 0, i32 1
  store double %29, double* %32, align 8
  %33 = bitcast { %f64Matrix*, double }* %30 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, double }*, i64, i64)* @average_tmp_thunk1 to i8*), i8* %33, i64 %5) #3
  br label %exit
...
polly.loop_header21.us.us:                        ; preds = %polly.loop_header21.us.us, %polly.loop_header12.us.us
  ...
  %uglygep30.us.us = bitcast i8* %uglygep.us.us to double*
  %_p_scalar_.us.us = load double, double* %uglygep30.us.us, align 8, !alias.scope !3, !noalias !5
  %49 = add i64 %48, %46
  %uglygep33.us.us = getelementptr i8, i8* %scevgep3132, i64 %49
  %uglygep3334.us.us = bitcast i8* %uglygep33.us.us to double*
  %_p_scalar_35.us.us = load double, double* %uglygep3334.us.us, align 8, !alias.scope !7, !noalias !8
  %p_36.us.us = fadd fast double %_p_scalar_35.us.us, %_p_scalar_.us.us
  store double %p_36.us.us, double* %uglygep30.us.us, align 8, !alias.scope !3, !noalias !5
...
polly.loop_preheader:                             ; preds = %polly.merge
  ...
  %scevgep31 = getelementptr %f64Matrix, %f64Matrix* %0, i64 1
  %scevgep3132 = bitcast %f64Matrix* %scevgep31 to i8*
