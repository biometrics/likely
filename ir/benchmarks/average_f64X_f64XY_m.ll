...
define %f64Matrix* @average(%f64Matrix* nocapture readonly) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, i32 }*, i64, i64)* @average_tmp_thunk0 to i8*), i8* %8, i64 %4)
...
true_entry:                                       ; preds = %y_exit
  ...
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, double }*, i64, i64)* @average_tmp_thunk1 to i8*), i8* %26, i64 %4)
  br label %exit
