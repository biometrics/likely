...
define %f64X* @average(%f64XY* nocapture readonly) {
entry:
...
true_entry:                                       ; preds = %y_exit
  ...
  %23 = alloca { %f64X*, double }, align 8
  %24 = bitcast { %f64X*, double }* %23 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %24, align 8
  %25 = getelementptr inbounds { %f64X*, double }, { %f64X*, double }* %23, i64 0, i32 1
  store double %22, double* %25, align 8
  %26 = bitcast { %f64X*, double }* %23 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64X*, double }*, i64, i64)* @average_tmp_thunk1 to i8*), i8* %26, i64 %4)
  br label %exit
