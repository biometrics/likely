...
define noalias %f32SXY* @covariance(%i16SXY* nocapture readonly) {
entry:
...
x_body7:                                          ; preds = %y_body, %x_body7
  ...
  %13 = getelementptr %i16SXY, %i16SXY* %0, i64 0, i32 6, i64 %12
...
y_body28:                                         ; preds = %y_body28, %Flow3
  ...
  %27 = getelementptr %i16SXY, %i16SXY* %0, i64 0, i32 6, i64 %y30
  %28 = load i16, i16* %27, align 2, !llvm.mem.parallel_loop_access !2
  %29 = getelementptr float, float* %22, i64 %y30
  %30 = sitofp i16 %28 to float
...
y_body68:                                         ; preds = %x_exit72, %y_exit48
  ...
  %41 = mul nuw nsw i64 %y70, %4
  br label %x_body71

x_body71:                                         ; preds = %y_body68, %Flow
  %x73 = phi i64 [ %x_increment78, %Flow ], [ 0, %y_body68 ]
  %42 = icmp ugt i64 %y70, %x73
  br i1 %42, label %Flow, label %true_entry76
...
y_exit69:                                         ; preds = %x_exit72
  ...
  %43 = bitcast %u0CXYT* %2 to i8*
  call void @likely_release_mat(i8* %43)
  %44 = bitcast %u0CXYT* %20 to i8*
...
exit77:                                           ; preds = %true_entry76
  %61 = add nuw nsw i64 %x73, %41
  %62 = getelementptr float, float* %40, i64 %61
  ...
  %66 = getelementptr float, float* %40, i64 %65
