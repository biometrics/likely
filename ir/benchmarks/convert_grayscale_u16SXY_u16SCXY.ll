...
y_body:                                           ; preds = %y_body, %entry
  ...
  %11 = getelementptr %u16Matrix, %u16Matrix* %0, i64 0, i32 6, i64 %8
  %12 = getelementptr i16, i16* %11, i64 1
  %13 = load i16, i16* %12, align 2, !llvm.mem.parallel_loop_access !1
  %14 = getelementptr %u16Matrix, %u16Matrix* %0, i64 0, i32 6, i64 %8
  %15 = getelementptr i16, i16* %14, i64 2
