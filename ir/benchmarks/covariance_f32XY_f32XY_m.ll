...
x_body:                                           ; preds = %y_body, %x_body
  ...
  store float %30, float* %32, align 4, !llvm.mem.parallel_loop_access !3
  %x_increment = add nuw nsw i64 %x, 1
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %35 = alloca { %f32XY*, %f32XY*, %f32X* }, align 8
  %36 = bitcast { %f32XY*, %f32XY*, %f32X* }* %35 to %u0CXYT**
  store %u0CXYT* %33, %u0CXYT** %36, align 8
  %37 = getelementptr inbounds { %f32XY*, %f32XY*, %f32X* }, { %f32XY*, %f32XY*, %f32X* }* %35, i64 0, i32 1
  store %f32XY* %0, %f32XY** %37, align 8
  %38 = getelementptr inbounds { %f32XY*, %f32XY*, %f32X* }, { %f32XY*, %f32XY*, %f32X* }* %35, i64 0, i32 2
  %39 = bitcast %f32X** %38 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %39, align 8
  %40 = bitcast { %f32XY*, %f32XY*, %f32X* }* %35 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %f32XY*, %f32X* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %40, i64 %34)
  %41 = call %u0CXYT* @likely_new(i32 24864, i32 1, i32 %columns7, i32 %columns7, i32 1, i8* null)
