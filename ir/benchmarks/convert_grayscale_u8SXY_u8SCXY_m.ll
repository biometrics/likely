...
y_body:                                           ; preds = %y_body, %entry
  ...
  %14 = getelementptr %u8Matrix, %u8Matrix* %6, i64 0, i32 6, i64 %13
  %15 = load i8, i8* %14, align 1, !llvm.mem.parallel_loop_access !1
  %16 = add nuw nsw i64 %10, 2
  %17 = getelementptr %u8Matrix, %u8Matrix* %6, i64 0, i32 6, i64 %16
...
define %u8Matrix* @convert_grayscale(%u8Matrix*) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, %u8Matrix* }*, i64, i64)* @convert_grayscale_tmp_thunk0 to i8*), i8* %8, i64 %4)
  ret %u8Matrix* %dst
}
