...
true_enry:                                        ; preds = %c_body, %true_enry
  ...
  %18 = phi i8 [ -1, %c_body ], [ %.1, %true_enry ]
  %19 = phi i32 [ 0, %c_body ], [ %., %true_enry ]
  %20 = phi i8 [ 0, %c_body ], [ %30, %true_enry ]
