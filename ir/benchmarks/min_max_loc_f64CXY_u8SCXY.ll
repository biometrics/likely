...
true_entry:                                       ; preds = %c_body, %true_entry
  ...
  %18 = phi i8 [ %current-value., %true_entry ], [ -1, %c_body ]
  %19 = phi i32 [ %., %true_entry ], [ 0, %c_body ]
  %20 = phi i8 [ %29, %true_entry ], [ 0, %c_body ]
  %21 = phi i32 [ %28, %true_entry ], [ 0, %c_body ]
  %22 = sext i32 %17 to i64
  %23 = mul nuw nsw i64 %22, %5
  %24 = add nuw nsw i64 %23, %c
  %25 = getelementptr %u8SCXY, %u8SCXY* %0, i64 0, i32 6, i64 %24
  %current-value = load i8, i8* %25, align 1, !llvm.mem.parallel_loop_access !1
  %26 = icmp ult i8 %current-value, %18
  %. = select i1 %26, i32 %17, i32 %19
  %current-value. = select i1 %26, i8 %current-value, i8 %18
  %27 = icmp ugt i8 %current-value, %20
  %28 = select i1 %27, i32 %17, i32 %21
  %29 = select i1 %27, i8 %current-value, i8 %20
...
exit:                                             ; preds = %true_entry
  ...
  %33 = uitofp i8 %current-value. to double
