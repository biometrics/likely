...
define noalias %f32X* @average(%f32XY* nocapture readonly) {
entry:
...
x_body15:                                         ; preds = %true_entry, %x_body15
  ...
  %20 = getelementptr float, float* %6, i64 %x17
  %21 = load float, float* %20, align 4, !llvm.mem.parallel_loop_access !1
  %22 = fmul fast float %21, %19
  store float %22, float* %20, align 4, !llvm.mem.parallel_loop_access !1
