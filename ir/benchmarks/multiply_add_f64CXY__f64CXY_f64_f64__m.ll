...
entry:
  ...
  %7 = getelementptr inbounds { %f64Matrix*, %f64Matrix*, double, double }, { %f64Matrix*, %f64Matrix*, double, double }* %0, i64 0, i32 2
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds { %f64Matrix*, %f64Matrix*, double, double }, { %f64Matrix*, %f64Matrix*, double, double }* %0, i64 0, i32 3
  %10 = load double, double* %9, align 8
  %11 = getelementptr inbounds %f64Matrix, %f64Matrix* %6, i64 0, i32 2
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %18 = getelementptr %f64Matrix, %f64Matrix* %4, i64 0, i32 6, i64 %y
...
define %f64Matrix* @multiply_add(%f64Matrix*, double, double) {
entry:
  ...
  %8 = alloca { %f64Matrix*, %f64Matrix*, double, double }, align 8
  %9 = bitcast { %f64Matrix*, %f64Matrix*, double, double }* %8 to %u0Matrix**
  store %u0Matrix* %6, %u0Matrix** %9, align 8
  %10 = getelementptr inbounds { %f64Matrix*, %f64Matrix*, double, double }, { %f64Matrix*, %f64Matrix*, double, double }* %8, i64 0, i32 1
  store %f64Matrix* %0, %f64Matrix** %10, align 8
  %11 = getelementptr inbounds { %f64Matrix*, %f64Matrix*, double, double }, { %f64Matrix*, %f64Matrix*, double, double }* %8, i64 0, i32 2
  store double %1, double* %11, align 8
  %12 = getelementptr inbounds { %f64Matrix*, %f64Matrix*, double, double }, { %f64Matrix*, %f64Matrix*, double, double }* %8, i64 0, i32 3
  store double %2, double* %12, align 8
  %13 = bitcast { %f64Matrix*, %f64Matrix*, double, double }* %8 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, %f64Matrix*, double, double }*, i64, i64)* @multiply_add_tmp_thunk0 to i8*), i8* %13, i64 %7)
  ret %f64Matrix* %dst
}
