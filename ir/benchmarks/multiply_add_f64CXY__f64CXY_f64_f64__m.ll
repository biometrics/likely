...
entry:
  ...
  %11 = getelementptr %f64CXY, %f64CXY* %4, i64 0, i32 2
  ...
  %17 = getelementptr %f64CXY, %f64CXY* %6, i64 0, i32 2
...
c_body:                                           ; preds = %c_body, %x_body
  ...
  %27 = load double, double* %26, align 8, !llvm.mem.parallel_loop_access !0
  %28 = fmul double %8, %27
  %29 = fadd double %10, %28
  %30 = add i64 %tmp6, %c
  %31 = getelementptr %f64CXY, %f64CXY* %4, i64 0, i32 6, i64 %30
  store double %29, double* %31, align 8, !llvm.mem.parallel_loop_access !0
...
entry:
  %3 = getelementptr %f64CXY, %f64CXY* %0, i64 0, i32 2
  ...
  %6 = call %u0CXYT* @likely_new(i32 28992, i32 %combine.extract.trunc, i32 %combine.extract.trunc1, i32 %rows, i32 1, i8* null)
