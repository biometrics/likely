...
; Function Attrs: nounwind
define private void @binary_threshold_tmp_thunk0({ %f32CXY*, %f32CXY*, float, float }* noalias nocapture readonly, i64, i64) #0 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %26 = fcmp ogt float %25, %8
  %27 = select i1 %26, float %10, float 0.000000e+00
