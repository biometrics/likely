...
define private void @binary_threshold_tmp_thunk0({ %f32Matrix*, %f32Matrix*, float, float }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %17 = fcmp fast ogt float %16, %8
  %. = select i1 %17, float %10, float 0.000000e+00
  %18 = getelementptr %f32Matrix, %f32Matrix* %4, i64 0, i32 6, i64 %y
  store float %., float* %18, align 4, !llvm.mem.parallel_loop_access !1
