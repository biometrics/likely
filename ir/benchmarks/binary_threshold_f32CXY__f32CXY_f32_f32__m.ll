...
entry:
  ...
  %11 = getelementptr %f32CXY, %f32CXY* %4, i64 0, i32 2
  ...
  %17 = getelementptr %f32CXY, %f32CXY* %6, i64 0, i32 2
...
c_body:                                           ; preds = %c_body, %x_body
  ...
  %27 = load float, float* %26, align 4, !llvm.mem.parallel_loop_access !0
  %28 = fcmp ogt float %27, %8
  %29 = select i1 %28, float %10, float 0.000000e+00
  %30 = add i64 %tmp6, %c
  %31 = getelementptr %f32CXY, %f32CXY* %4, i64 0, i32 6, i64 %30
  store float %29, float* %31, align 4, !llvm.mem.parallel_loop_access !0
...
entry:
  ...
  %6 = call %u0CXYT* @likely_new(i32 28960, i32 %combine.extract.trunc, i32 %combine.extract.trunc1, i32 %rows, i32 1, i8* null)
