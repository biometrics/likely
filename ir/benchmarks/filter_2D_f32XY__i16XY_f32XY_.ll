...
y_exit10:                                         ; preds = %y_body9
  %30 = call %u0CXYT* @likely_new(i32 24864, i32 1, i32 %columns, i32 %rows, i32 1, i8* null)
  %31 = getelementptr inbounds %u0CXYT, %u0CXYT* %30, i64 1
  %32 = bitcast %u0CXYT* %31 to float*
...
true_entry39:                                     ; preds = %loop38.preheader, %true_entry39
  ...
  %51 = getelementptr %f32XY, %f32XY* %1, i64 0, i32 6, i64 %50
