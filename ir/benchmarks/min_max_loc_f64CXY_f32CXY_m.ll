...
entry:
  ...
  %7 = getelementptr { %f64CXY*, %f32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %f32CXY*, i32, i32, i64, i64, i64, i64 }* %0, i64 0, i32 2
...
then5:                                            ; preds = %then5.lr.ph, %end10
  ...
  %62 = add i64 %tmp12, %c
  %63 = getelementptr %f32CXY, %f32CXY* %6, i64 0, i32 6, i64 %62
  %64 = load float, float* %63, align 4, !llvm.mem.parallel_loop_access !0
