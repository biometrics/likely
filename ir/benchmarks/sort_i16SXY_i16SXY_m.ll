...
define noalias %u16Matrix* @sort(%u16Matrix* noalias nocapture) #1 {
entry:
  br label %entry.split
...
entry.split:                                      ; preds = %entry
  ...
  call void @likely_fork(i8* bitcast (void ({ %u16Matrix*, i32, i64, i64, i64, i64 }*, i64, i64)* @sort_tmp_thunk0 to i8*), i8* %10, i64 %2) #1
