...
entry:
  ...
  %7 = getelementptr inbounds %i32XY, %i32XY* %6, i64 0, i32 4
  %rows2 = load i32, i32* %7, align 4, !range !0
  %dst_y_step = zext i32 %rows2 to i64
  %8 = getelementptr inbounds %i32XY, %i32XY* %6, i64 0, i32 3
  %columns1 = load i32, i32* %8, align 4, !range !0
  %9 = getelementptr inbounds %i32XY, %i32XY* %4, i64 0, i32 6, i64 0
  %10 = ptrtoint i32* %9 to i64
  %11 = and i64 %10, 31
  %12 = icmp eq i64 %11, 0
  call void @llvm.assume(i1 %12)
  %src_y_step = zext i32 %columns1 to i64
  %13 = getelementptr inbounds %i32XY, %i32XY* %6, i64 0, i32 6, i64 0
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %20 = getelementptr %i32XY, %i32XY* %6, i64 0, i32 6, i64 %19
  %21 = load i32, i32* %20, align 4, !llvm.mem.parallel_loop_access !1
  %22 = add nuw nsw i64 %x, %17
  %23 = getelementptr %i32XY, %i32XY* %4, i64 0, i32 6, i64 %22
  store i32 %21, i32* %23, align 4, !llvm.mem.parallel_loop_access !1
