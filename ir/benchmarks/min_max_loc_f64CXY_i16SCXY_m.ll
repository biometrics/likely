...
true_enry:                                        ; preds = %c_body, %true_enry
  ...
  %25 = phi i16 [ %.8, %true_enry ], [ 32767, %c_body ]
  %26 = phi i32 [ %., %true_enry ], [ 0, %c_body ]
  %27 = phi i16 [ %37, %true_enry ], [ -32768, %c_body ]
...
exit:                                             ; preds = %true_enry, %c_body
  %.lcssa11 = phi i16 [ 32767, %c_body ], [ %.8, %true_enry ]
  %.lcssa10 = phi i32 [ 0, %c_body ], [ %., %true_enry ]
  %.lcssa9 = phi i16 [ -32768, %c_body ], [ %37, %true_enry ]
