...
entry:
  ...
  %17 = getelementptr inbounds %i16SCXY, %i16SCXY* %6, i64 0, i32 3
  %columns2 = load i32, i32* %17, align 4, !range !0
  %src_x = zext i32 %columns2 to i64
  %18 = getelementptr inbounds %i16SCXY, %i16SCXY* %6, i64 0, i32 6, i64 0
...
then5:                                            ; preds = %then5.lr.ph, %then5
  ...
  %57 = add i64 %tmp11, %c
  %58 = getelementptr %i16SCXY, %i16SCXY* %6, i64 0, i32 6, i64 %57
  %59 = load i16, i16* %58, align 2, !llvm.mem.parallel_loop_access !1
