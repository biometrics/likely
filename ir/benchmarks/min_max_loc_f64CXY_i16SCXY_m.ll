...
define noalias %f64Matrix* @min_max_loc(%u16Matrix* noalias nocapture readonly) #1 {
entry:
...
true_entry:                                       ; preds = %true_entry, %entry.split
  ...
  %7 = phi i16 [ 32767, %entry.split ], [ %current-value., %true_entry ]
  %8 = phi i32 [ 0, %entry.split ], [ %., %true_entry ]
  %9 = phi i16 [ -32768, %entry.split ], [ %16, %true_entry ]
