...
define private void @sort_tmp_thunk0({ %f64Matrix*, i32, i64, i64, i64, i64 }* noalias nocapture readonly, i64, i64) #0 {
entry:
  %3 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %0, i64 0, i32 0
  %4 = load %f64Matrix*, %f64Matrix** %3, align 8
  %5 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %0, i64 0, i32 1
...
true_entry:                                       ; preds = %true_entry.lr.ph, %loop.backedge
  ...
  %13 = getelementptr %f64Matrix, %f64Matrix* %4, i64 0, i32 6, i64 %12
...
true_entry3:                                      ; preds = %true_entry, %true_entry3
  ...
  %22 = getelementptr %f64Matrix, %f64Matrix* %4, i64 0, i32 6, i64 %21
...
entry:
  ...
  %3 = alloca { %f64Matrix*, i32, i64, i64, i64, i64 }, align 8
  %4 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %3, i64 0, i32 0
  store %f64Matrix* %0, %f64Matrix** %4, align 8
  %5 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %3, i64 0, i32 1
  store i32 %len, i32* %5, align 8
  %6 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %3, i64 0, i32 2
  store i64 1, i64* %6, align 4
  %7 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %3, i64 0, i32 3
  store i64 1, i64* %7, align 4
  %8 = getelementptr inbounds { %f64Matrix*, i32, i64, i64, i64, i64 }, { %f64Matrix*, i32, i64, i64, i64, i64 }* %3, i64 0, i32 4
