...
loop6.preheader:                                  ; preds = %x_body, %exit8
  ...
  %22 = phi double [ %41, %exit8 ], [ 0.000000e+00, %x_body ]
...
exit:                                             ; preds = %exit8, %x_body
  %.lcssa9 = phi double [ 0.000000e+00, %x_body ], [ %41, %exit8 ]
  store double %.lcssa9, double* %20, align 8, !llvm.mem.parallel_loop_access !3
  %x_increment = add nuw nsw i64 %x, 1
...
true_entry7:                                      ; preds = %true_entry7.lr.ph, %true_entry7
  %28 = phi double [ %38, %true_entry7 ], [ %22, %true_entry7.lr.ph ]
...
exit8:                                            ; preds = %true_entry7, %loop6.preheader
  %41 = phi double [ %22, %loop6.preheader ], [ %38, %true_entry7 ]
...
; Function Attrs: nounwind
define noalias %f64Matrix* @filter_2D(%f64Matrix* noalias nocapture, %f64Matrix* noalias nocapture) #0 {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, i32 }*, i64, i64)* @filter_2D_tmp_thunk0 to i8*), i8* %19, i64 %15) #0
  ...
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, %f64Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk1 to i8*), i8* %27, i64 %20) #0
  ...
  call void @likely_fork(i8* bitcast (void ({ %f64Matrix*, %f64Matrix*, %f64Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk2 to i8*), i8* %37, i64 %29) #0
