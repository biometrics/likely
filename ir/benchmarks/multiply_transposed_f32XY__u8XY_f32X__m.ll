...
define private void @multiply_transposed_tmp_thunk0({ %f32XY*, %u8XY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %17 = getelementptr %u8XY, %u8XY* %6, i64 0, i32 6, i64 %y
...
entry:
  ...
  %6 = alloca { %f32XY*, %u8XY* }, align 8
  %7 = bitcast { %f32XY*, %u8XY* }* %6 to %u0CXYT**
  store %u0CXYT* %4, %u0CXYT** %7, align 8
  %8 = getelementptr inbounds { %f32XY*, %u8XY* }, { %f32XY*, %u8XY* }* %6, i64 0, i32 1
  store %u8XY* %0, %u8XY** %8, align 8
  %9 = bitcast { %f32XY*, %u8XY* }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %u8XY* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %9, i64 %5)
