...
define private void @multiply_transposed_tmp_thunk0({ %f32XY*, %f32XY*, %f32X* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  store float %28, float* %29, align 4, !llvm.mem.parallel_loop_access !1
...
entry:
  ...
  %6 = alloca { %f32XY*, %f32XY*, %f32X* }, align 8
  %7 = bitcast { %f32XY*, %f32XY*, %f32X* }* %6 to %u0CXYT**
  store %u0CXYT* %4, %u0CXYT** %7, align 8
  %8 = getelementptr inbounds { %f32XY*, %f32XY*, %f32X* }, { %f32XY*, %f32XY*, %f32X* }* %6, i64 0, i32 1
  store %f32XY* %0, %f32XY** %8, align 8
  %9 = getelementptr inbounds { %f32XY*, %f32XY*, %f32X* }, { %f32XY*, %f32XY*, %f32X* }* %6, i64 0, i32 2
  store %f32X* %1, %f32X** %9, align 8
  %10 = bitcast { %f32XY*, %f32XY*, %f32X* }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %f32XY*, %f32X* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %10, i64 %5)
