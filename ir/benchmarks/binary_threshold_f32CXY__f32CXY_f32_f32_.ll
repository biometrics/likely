...
; Function Attrs: nounwind
define %f32CXY* @binary_threshold(%f32CXY*, float, float) #1 {
entry:
...
x_body:                                           ; preds = %x_body, %y_body
  ...
  %24 = select i1 %23, float %2, float 0.000000e+00
  %25 = getelementptr float, float* %9, i64 %20
