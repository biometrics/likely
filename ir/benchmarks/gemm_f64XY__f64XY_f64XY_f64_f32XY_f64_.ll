...
; Function Attrs: nounwind
define noalias %f32Matrix* @gemm(%f64Matrix* noalias nocapture readonly, %f64Matrix* noalias nocapture readonly, double, %f32Matrix* noalias nocapture readonly, double) #0 {
entry:
