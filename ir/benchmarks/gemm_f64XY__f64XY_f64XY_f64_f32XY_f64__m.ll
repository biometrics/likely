...
entry:
  ...
  %19 = getelementptr inbounds %f64XY, %f64XY* %8, i64 0, i32 3
...
true_entry:                                       ; preds = %x_body, %true_entry
  ...
  %33 = getelementptr %f64XY, %f64XY* %8, i64 0, i32 6, i64 %32
...
exit:                                             ; preds = %true_entry, %x_body
  ...
  %41 = getelementptr %f32XY, %f32XY* %12, i64 0, i32 6, i64 %23
...
entry:
  ...
  %16 = alloca { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, align 8
  %17 = bitcast { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16 to %u0CXYT**
  store %u0CXYT* %14, %u0CXYT** %17, align 8
  %18 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 1
  store %f64XY* %0, %f64XY** %18, align 8
  %19 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 2
  store %f64XY* %1, %f64XY** %19, align 8
  %20 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 3
  store double %2, double* %20, align 8
  %21 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 4
  store %f32XY* %3, %f32XY** %21, align 8
  %22 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 5
  store double %4, double* %22, align 8
  %23 = getelementptr inbounds { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }, { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16, i64 0, i32 6
  store i32 %columns, i32* %23, align 8
  %24 = bitcast { %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }* %16 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %f64XY*, %f64XY*, double, %f32XY*, double, i32 }*, i64, i64)* @gemm_tmp_thunk0 to i8*), i8* %24, i64 %15)
  ret %f32XY* %dst
}
