...
x_body:                                           ; preds = %x_body, %entry
  ...
  %8 = getelementptr %f64X, %f64X* %4, i64 0, i32 6, i64 %x
...
x_body:                                           ; preds = %x_body, %entry
  %x = phi i64 [ %1, %entry ], [ %x_increment, %x_body ]
  %7 = getelementptr %f64X, %f64X* %4, i64 0, i32 6, i64 %x
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %12 = getelementptr %f64XY, %f64XY* %6, i64 0, i32 6, i64 %11
  %13 = load double, double* %12, align 8, !llvm.mem.parallel_loop_access !3
  %14 = add nuw nsw i64 %x, %10
  %15 = getelementptr %f64XY, %f64XY* %4, i64 0, i32 6, i64 %14
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %16 = getelementptr %f64XY, %f64XY* %0, i64 0, i32 6, i64 %15
...
true_entry:                                       ; preds = %y_exit
  ...
  %22 = alloca { %f64X*, double }, align 8
  %23 = bitcast { %f64X*, double }* %22 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %23, align 8
  %24 = getelementptr inbounds { %f64X*, double }, { %f64X*, double }* %22, i64 0, i32 1
  store double %21, double* %24, align 8
  %25 = bitcast { %f64X*, double }* %22 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64X*, double }*, i64, i64)* @covariance_tmp_thunk1 to i8*), i8* %25, i64 %4)
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %26 = call %u0CXYT* @likely_new(i32 24896, i32 1, i32 %columns7, i32 %rows8, i32 1, i8* null)
  %27 = zext i32 %rows8 to i64
  %28 = alloca { %f64XY*, %f64XY* }, align 8
  %29 = bitcast { %f64XY*, %f64XY* }* %28 to %u0CXYT**
  store %u0CXYT* %26, %u0CXYT** %29, align 8
  %30 = getelementptr inbounds { %f64XY*, %f64XY* }, { %f64XY*, %f64XY* }* %28, i64 0, i32 1
  store %f64XY* %0, %f64XY** %30, align 8
  %31 = bitcast { %f64XY*, %f64XY* }* %28 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64XY*, %f64XY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %31, i64 %27)
  %32 = alloca { %f64XY*, %f64X* }, align 8
  %33 = bitcast { %f64XY*, %f64X* }* %32 to %u0CXYT**
  store %u0CXYT* %26, %u0CXYT** %33, align 8
  %34 = getelementptr inbounds { %f64XY*, %f64X* }, { %f64XY*, %f64X* }* %32, i64 0, i32 1
  %35 = bitcast %f64X** %34 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %35, align 8
  %36 = bitcast { %f64XY*, %f64X* }* %32 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64XY*, %f64X* }*, i64, i64)* @covariance_tmp_thunk3 to i8*), i8* %36, i64 %27)
  %37 = call %u0CXYT* @likely_new(i32 24896, i32 1, i32 %columns7, i32 %columns7, i32 1, i8* null)
  %dst = bitcast %u0CXYT* %37 to %f64XY*
  %38 = zext i32 %columns7 to i64
  %39 = alloca { %f64XY*, %f64XY*, i32 }, align 8
  %40 = bitcast { %f64XY*, %f64XY*, i32 }* %39 to %u0CXYT**
  store %u0CXYT* %37, %u0CXYT** %40, align 8
  %41 = getelementptr inbounds { %f64XY*, %f64XY*, i32 }, { %f64XY*, %f64XY*, i32 }* %39, i64 0, i32 1
  %42 = bitcast %f64XY** %41 to %u0CXYT**
  store %u0CXYT* %26, %u0CXYT** %42, align 8
  %43 = getelementptr inbounds { %f64XY*, %f64XY*, i32 }, { %f64XY*, %f64XY*, i32 }* %39, i64 0, i32 2
  store i32 %rows8, i32* %43, align 8
  %44 = bitcast { %f64XY*, %f64XY*, i32 }* %39 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64XY*, %f64XY*, i32 }*, i64, i64)* @covariance_tmp_thunk4 to i8*), i8* %44, i64 %38)
