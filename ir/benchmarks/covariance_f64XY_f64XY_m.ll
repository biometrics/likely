...
then3:                                            ; preds = %label.preheader, %then3
  %21 = phi i32 [ %33, %then3 ], [ 0, %label.preheader ]
  %22 = phi double [ %32, %then3 ], [ 0.000000e+00, %label.preheader ]
  ...
  %34 = icmp eq i32 %33, %8
  br i1 %34, label %end4, label %then3

end4:                                             ; preds = %then3, %label.preheader
  %.lcssa = phi double [ 0.000000e+00, %label.preheader ], [ %32, %then3 ]
