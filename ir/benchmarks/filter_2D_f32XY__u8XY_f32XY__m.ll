...
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, i32 }*, i64, i64)* @filter_2D_tmp_thunk0 to i8*), i8* %19, i64 %15) #0
  ...
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, %u8Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk1 to i8*), i8* %27, i64 %20) #0
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk2 to i8*), i8* %37, i64 %29) #0
