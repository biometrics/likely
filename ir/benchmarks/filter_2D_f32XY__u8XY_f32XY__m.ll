...
entry:
  ...
  %7 = getelementptr inbounds %u8Matrix, %u8Matrix* %4, i64 0, i32 3
  %columns = load i32, i32* %7, align 4, !range !0
  %mat_y_step = zext i32 %columns to i64
  %scevgep = getelementptr %u8Matrix, %u8Matrix* %4, i64 1, i32 0
...
entry:
  ...
  %7 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %0, i64 0, i32 2
  %8 = load i32, i32* %7, align 4
  %9 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %0, i64 0, i32 3
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds %u8Matrix, %u8Matrix* %4, i64 0, i32 3
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %20 = getelementptr %u8Matrix, %u8Matrix* %4, i64 0, i32 6, i64 %19
  %21 = load i8, i8* %20, align 1, !llvm.mem.parallel_loop_access !1
  %22 = add i64 %18, %x
  %23 = getelementptr %u8Matrix, %u8Matrix* %6, i64 0, i32 6, i64 %22
...
entry:
  ...
  %6 = load %u8Matrix*, %u8Matrix** %5, align 8
  %7 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 2
  %8 = load %f32Matrix*, %f32Matrix** %7, align 8
  %9 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 3
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 4
  ...
  %14 = getelementptr inbounds %u8Matrix, %u8Matrix* %6, i64 0, i32 3
...
true_entry7:                                      ; preds = %true_entry7.lr.ph, %true_entry7
  ...
  %31 = add i64 %26, %30
  %32 = getelementptr %u8Matrix, %u8Matrix* %6, i64 0, i32 6, i64 %31
...
define %f32Matrix* @filter_2D(%u8Matrix*, %f32Matrix*) {
entry:
  ...
  %16 = alloca { %u8Matrix*, i32 }, align 8
  %17 = bitcast { %u8Matrix*, i32 }* %16 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %17, align 8
  %18 = getelementptr inbounds { %u8Matrix*, i32 }, { %u8Matrix*, i32 }* %16, i64 0, i32 1
  store i32 0, i32* %18, align 8
  %19 = bitcast { %u8Matrix*, i32 }* %16 to i8*
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, i32 }*, i64, i64)* @filter_2D_tmp_thunk0 to i8*), i8* %19, i64 %15)
  %pad-columns = sdiv i32 %9, 2
  %pad-rows = sdiv i32 %12, 2
  %rows2 = load i32, i32* %11, align 4, !range !0
  %20 = zext i32 %rows2 to i64
  %21 = alloca { %u8Matrix*, %u8Matrix*, i32, i32 }, align 8
  %22 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %21, i64 0, i32 0
  store %u8Matrix* %0, %u8Matrix** %22, align 8
  %23 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %21, i64 0, i32 1
  %24 = bitcast %u8Matrix** %23 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %24, align 8
  %25 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %21, i64 0, i32 2
  store i32 %pad-columns, i32* %25, align 8
  %26 = getelementptr inbounds { %u8Matrix*, %u8Matrix*, i32, i32 }, { %u8Matrix*, %u8Matrix*, i32, i32 }* %21, i64 0, i32 3
  store i32 %pad-rows, i32* %26, align 4
  %27 = bitcast { %u8Matrix*, %u8Matrix*, i32, i32 }* %21 to i8*
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, %u8Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk1 to i8*), i8* %27, i64 %20)
  ...
  %30 = alloca { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, align 8
  %31 = bitcast { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30 to %u0Matrix**
  store %u0Matrix* %28, %u0Matrix** %31, align 8
  %32 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 1
  %33 = bitcast %u8Matrix** %32 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %33, align 8
  %34 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 2
  store %f32Matrix* %1, %f32Matrix** %34, align 8
  %35 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 3
  store i32 %width, i32* %35, align 8
  %36 = getelementptr inbounds { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 4
  store i32 %height, i32* %36, align 4
  %37 = bitcast { %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }* %30 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %u8Matrix*, %f32Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk2 to i8*), i8* %37, i64 %29)
