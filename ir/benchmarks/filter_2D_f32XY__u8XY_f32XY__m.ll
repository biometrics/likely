...
entry:
  ...
  %12 = getelementptr inbounds %u8XY, %u8XY* %6, i64 0, i32 3
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %20 = getelementptr %u8XY, %u8XY* %4, i64 0, i32 6, i64 %19
  %21 = load i8, i8* %20, align 1, !llvm.mem.parallel_loop_access !1
  %22 = add i64 %18, %x
  %23 = getelementptr %u8XY, %u8XY* %6, i64 0, i32 6, i64 %22
...
exit:                                             ; preds = %exit8, %x_body
  ...
  store float %.lcssa9, float* %20, align 4, !llvm.mem.parallel_loop_access !2
  %x_increment = add nuw nsw i64 %x, 1
...
true_entry7:                                      ; preds = %true_entry7.lr.ph, %true_entry7
  ...
  %31 = add i64 %26, %30
  %32 = getelementptr %u8XY, %u8XY* %6, i64 0, i32 6, i64 %31
  %33 = load i8, i8* %32, align 1, !llvm.mem.parallel_loop_access !2
