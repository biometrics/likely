...
x_body15:                                         ; preds = %true_entry, %x_body15
  ...
  %33 = getelementptr double, double* %6, i64 %x17
  %34 = load double, double* %33, align 8, !llvm.mem.parallel_loop_access !1
  %35 = fmul fast double %34, %25
  store double %35, double* %33, align 8, !llvm.mem.parallel_loop_access !1
...
y_body28:                                         ; preds = %y_body28, %Flow9
  ...
  %36 = mul i64 %y30, %32
  %scevgep1 = getelementptr i32, i32* %scevgep, i64 %36
  %scevgep12 = bitcast i32* %scevgep1 to i8*
  %scevgep4 = getelementptr i32, i32* %scevgep3, i64 %36
...
x_body50:                                         ; preds = %y_body47, %x_body50
  ...
  %39 = getelementptr double, double* %28, i64 %38
