...
Flow7:                                            ; preds = %x_body15, %y_exit
  %20 = call %u0CXYT* @likely_new(i32 24896, i32 1, i32 %columns, i32 %rows, i32 1, i8* null)
...
y_body47.preheader:                               ; preds = %y_body28
  %27 = bitcast %u0CXYT* %21 to double*
  br label %y_body47
...
y_exit48:                                         ; preds = %x_exit51
  %35 = call %u0CXYT* @likely_new(i32 24896, i32 1, i32 %columns, i32 %columns, i32 1, i8* null)
...
y_exit69:                                         ; preds = %x_exit72
  ...
  %40 = bitcast %u0CXYT* %2 to i8*
  call void @likely_release_mat(i8* %40)
  %41 = bitcast %u0CXYT* %20 to i8*
