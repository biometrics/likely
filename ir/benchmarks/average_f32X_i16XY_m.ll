...
true_entry:                                       ; preds = %y_exit
  ...
  %31 = alloca { %f32X*, float }, align 8
  %32 = bitcast { %f32X*, float }* %31 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %32, align 8
  %33 = getelementptr inbounds { %f32X*, float }, { %f32X*, float }* %31, i64 0, i32 1
  store float %30, float* %33, align 8
  %34 = bitcast { %f32X*, float }* %31 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32X*, float }*, i64, i64)* @average_tmp_thunk1 to i8*), i8* %34, i64 %4)
  br label %exit
