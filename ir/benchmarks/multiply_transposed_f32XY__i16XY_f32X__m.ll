...
define private void @multiply_transposed_tmp_thunk0({ %f32XY*, %i16XY*, %f32X* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %0, i64 0, i32 0
  %4 = load %f32XY*, %f32XY** %3, align 8
  %5 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %0, i64 0, i32 1
  %6 = load %i16XY*, %i16XY** %5, align 8
  %7 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %0, i64 0, i32 2
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %24 = getelementptr %i16XY, %i16XY* %6, i64 0, i32 6, i64 %23
...
entry:
  ...
  %6 = alloca { %f32XY*, %i16XY*, %f32X* }, align 8
  %7 = bitcast { %f32XY*, %i16XY*, %f32X* }* %6 to %u0CXYT**
  store %u0CXYT* %4, %u0CXYT** %7, align 8
  %8 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %6, i64 0, i32 1
  store %i16XY* %0, %i16XY** %8, align 8
  %9 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %6, i64 0, i32 2
  store %f32X* %1, %f32X** %9, align 8
  %10 = bitcast { %f32XY*, %i16XY*, %f32X* }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %i16XY*, %f32X* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %10, i64 %5)
  %11 = call %u0CXYT* @likely_new(i32 24864, i32 1, i32 %columns, i32 %columns, i32 1, i8* null)
  %dst = bitcast %u0CXYT* %11 to %f32XY*
  %12 = zext i32 %columns to i64
  %13 = alloca { %f32XY*, %f32XY*, i32 }, align 8
  %14 = bitcast { %f32XY*, %f32XY*, i32 }* %13 to %u0CXYT**
  store %u0CXYT* %11, %u0CXYT** %14, align 8
  %15 = getelementptr inbounds { %f32XY*, %f32XY*, i32 }, { %f32XY*, %f32XY*, i32 }* %13, i64 0, i32 1
  %16 = bitcast %f32XY** %15 to %u0CXYT**
  store %u0CXYT* %4, %u0CXYT** %16, align 8
  %17 = getelementptr inbounds { %f32XY*, %f32XY*, i32 }, { %f32XY*, %f32XY*, i32 }* %13, i64 0, i32 2
  store i32 %rows, i32* %17, align 8
  %18 = bitcast { %f32XY*, %f32XY*, i32 }* %13 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %f32XY*, i32 }*, i64, i64)* @multiply_transposed_tmp_thunk1 to i8*), i8* %18, i64 %12)
