...
define private void @multiply_transposed_tmp_thunk0({ %f32Matrix*, %u8Matrix* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %9 = getelementptr %u8Matrix, %u8Matrix* %6, i64 0, i32 6, i64 %y
...
define noalias %f32Matrix* @multiply_transposed(%u8Matrix* noalias nocapture, %f32Matrix* noalias nocapture) #2 {
entry:
  ...
  %6 = alloca { %f32Matrix*, %u8Matrix* }, align 8
  %7 = bitcast { %f32Matrix*, %u8Matrix* }* %6 to %u0Matrix**
  store %u0Matrix* %4, %u0Matrix** %7, align 8
  %8 = getelementptr inbounds { %f32Matrix*, %u8Matrix* }, { %f32Matrix*, %u8Matrix* }* %6, i64 0, i32 1
  store %u8Matrix* %0, %u8Matrix** %8, align 8
  %9 = bitcast { %f32Matrix*, %u8Matrix* }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %u8Matrix* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %9, i64 %5) #2
