...
define %f32Matrix* @multiply_transposed(%u8Matrix*, %f32Matrix*) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %u8Matrix* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %9, i64 %5)
