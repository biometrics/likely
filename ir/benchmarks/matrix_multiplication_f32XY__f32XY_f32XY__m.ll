...
define private void @matrix_multiplication_tmp_thunk0({ %f32XY*, %f32XY*, %f32XY*, i32 }* noalias nocapture readonly, i64, i64) #2 {
entry:
...
true_entry:                                       ; preds = %x_body, %true_entry
  ...
  %24 = getelementptr %f32XY, %f32XY* %8, i64 0, i32 6, i64 %23
