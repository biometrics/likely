...
entry:
  ...
  %7 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %0, i64 0, i32 2
  %8 = load %f32Matrix*, %f32Matrix** %7, align 8
  %9 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %0, i64 0, i32 3
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds %f32Matrix, %f32Matrix* %8, i64 0, i32 3
...
true_entry:                                       ; preds = %x_body, %true_entry
  ...
  %17 = phi float [ %27, %true_entry ], [ 0.000000e+00, %x_body ]
  %18 = sext i32 %16 to i64
  %19 = add nuw nsw i64 %18, %15
  %20 = getelementptr %f32Matrix, %f32Matrix* %6, i64 0, i32 6, i64 %19
  %21 = load float, float* %20, align 4, !llvm.mem.parallel_loop_access !1
  %22 = mul nuw nsw i64 %18, %C_y_step
  %23 = add nuw nsw i64 %22, %x
  %24 = getelementptr %f32Matrix, %f32Matrix* %8, i64 0, i32 6, i64 %23
...
exit:                                             ; preds = %true_entry, %x_body
  %.lcssa = phi float [ 0.000000e+00, %x_body ], [ %27, %true_entry ]
  %30 = add nuw nsw i64 %x, %14
  %31 = getelementptr %f32Matrix, %f32Matrix* %4, i64 0, i32 6, i64 %30
  store float %.lcssa, float* %31, align 4, !llvm.mem.parallel_loop_access !1
...
define %f32Matrix* @matrix_multiplication(%f32Matrix*, %f32Matrix*) {
entry:
  ...
  %5 = getelementptr inbounds %f32Matrix, %f32Matrix* %1, i64 0, i32 3
  %columns1 = load i32, i32* %5, align 4, !range !0
  %6 = getelementptr inbounds %f32Matrix, %f32Matrix* %0, i64 0, i32 4
  %rows2 = load i32, i32* %6, align 4, !range !0
  %7 = call %u0Matrix* @likely_new(i32 24864, i32 1, i32 %columns1, i32 %rows2, i32 1, i8* null)
  %C = bitcast %u0Matrix* %7 to %f32Matrix*
  %8 = zext i32 %rows2 to i64
  %9 = alloca { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, align 8
  %10 = bitcast { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %9 to %u0Matrix**
  store %u0Matrix* %7, %u0Matrix** %10, align 8
  %11 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %9, i64 0, i32 1
  store %f32Matrix* %0, %f32Matrix** %11, align 8
  %12 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %9, i64 0, i32 2
  store %f32Matrix* %1, %f32Matrix** %12, align 8
  %13 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %9, i64 0, i32 3
  store i32 %columns, i32* %13, align 8
  %14 = bitcast { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }* %9 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix*, %f32Matrix*, i32 }*, i64, i64)* @matrix_multiplication_tmp_thunk0 to i8*), i8* %14, i64 %8)
  ret %f32Matrix* %C
}
