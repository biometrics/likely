...
define noalias %u8Matrix* @multiply_add(%u8Matrix* noalias nocapture, float, float) #2 {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %u8Matrix*, %u8Matrix*, float, float }*, i64, i64)* @multiply_add_tmp_thunk0 to i8*), i8* %13, i64 %7) #2
  ret %u8Matrix* %dst
}
