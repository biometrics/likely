...
x_body:                                           ; preds = %x_body, %y_body
  ...
  %27 = fmul float %8, %26
  %28 = fadd float %10, %27
  %29 = getelementptr %u8SCXY, %u8SCXY* %4, i64 0, i32 6, i64 %23
  %30 = fcmp olt float %28, 0.000000e+00
  %31 = select i1 %30, float -5.000000e-01, float 5.000000e-01
  %32 = fadd float %28, %31
  %33 = fptoui float %32 to i8
  %34 = fcmp olt float %32, 0.000000e+00
  %35 = select i1 %34, i8 0, i8 %33
  %36 = fcmp ogt float %32, 2.550000e+02
  %37 = select i1 %36, i8 -1, i8 %35
  store i8 %37, i8* %29, align 1, !llvm.mem.parallel_loop_access !1
