...
true_entry4:                                      ; preds = %true_entry, %true_entry4
  ...
  %14 = phi float [ %19, %true_entry4 ], [ %9, %true_entry ]
  %15 = sext i32 %12 to i64
  %16 = add nuw nsw i64 %15, %4
  %17 = getelementptr %f32Matrix, %f32Matrix* %0, i64 0, i32 6, i64 %16
  %element = load float, float* %17, align 4, !llvm.mem.parallel_loop_access !1
  %18 = fcmp fast olt float %element, %14
  %19 = select i1 %18, float %element, float %14
...
true_entry8:                                      ; preds = %exit5
  ...
  store float %27, float* %8, align 4, !llvm.mem.parallel_loop_access !1
  store float %9, float* %26, align 4, !llvm.mem.parallel_loop_access !1
...
y_exit:                                           ; preds = %exit
  %28 = bitcast %f32Matrix* %0 to i8*
  %29 = call i8* @likely_retain_mat(i8* %28) #1
  %30 = bitcast i8* %29 to %f32Matrix*
  ret %f32Matrix* %30
}
