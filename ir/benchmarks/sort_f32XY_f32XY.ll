...
entry:
  ...
  %4 = getelementptr inbounds %f32XY, %f32XY* %0, i64 0, i32 6, i64 0
...
true_entry:                                       ; preds = %y_body, %loop.backedge
  ...
  %12 = getelementptr %f32XY, %f32XY* %0, i64 0, i32 6, i64 %11
...
y_exit:                                           ; preds = %exit
  %16 = bitcast %f32XY* %0 to i8*
  %17 = call i8* @likely_retain_mat(i8* %16)
  %18 = bitcast i8* %17 to %f32XY*
  ret %f32XY* %18

true_entry4:                                      ; preds = %true_entry, %true_entry4
  %19 = phi i32 [ %28, %true_entry4 ], [ %14, %true_entry ]
  %20 = phi i32 [ %27, %true_entry4 ], [ %9, %true_entry ]
  %21 = phi float [ %26, %true_entry4 ], [ %13, %true_entry ]
  %22 = sext i32 %19 to i64
  %23 = add nuw nsw i64 %22, %8
  %24 = getelementptr %f32XY, %f32XY* %0, i64 0, i32 6, i64 %23
  %element = load float, float* %24, align 4, !llvm.mem.parallel_loop_access !1
  %25 = fcmp fast olt float %element, %21
  %26 = select i1 %25, float %element, float %21
...
true_entry8:                                      ; preds = %exit5
  ...
  store float %34, float* %12, align 4, !llvm.mem.parallel_loop_access !1
  store float %13, float* %33, align 4, !llvm.mem.parallel_loop_access !1
