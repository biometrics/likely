...
define private void @filter_2D_tmp_thunk0({ %f32Matrix*, i32 }* noalias nocapture readonly, i64, i64) #2 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %10 = getelementptr %f32Matrix, %f32Matrix* %4, i64 0, i32 6, i64 %y
...
; Function Attrs: norecurse nounwind
define private void @filter_2D_tmp_thunk1({ %f32Matrix*, %f32Matrix*, i32, i32 }* noalias nocapture readonly, i64, i64) #2 {
entry:
  %3 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 0
  %4 = load %f32Matrix*, %f32Matrix** %3, align 8
  %5 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 1
  %6 = load %f32Matrix*, %f32Matrix** %5, align 8
  %7 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 2
  %8 = load i32, i32* %7, align 4
  %9 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %0, i64 0, i32 3
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr inbounds %f32Matrix, %f32Matrix* %4, i64 0, i32 3
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %22 = add i64 %18, %x
  %23 = getelementptr %f32Matrix, %f32Matrix* %6, i64 0, i32 6, i64 %22
...
; Function Attrs: norecurse nounwind
define private void @filter_2D_tmp_thunk2({ %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* noalias nocapture readonly, i64, i64) #2 {
entry:
...
; Function Attrs: nounwind
define noalias %f32Matrix* @filter_2D(%f32Matrix* noalias nocapture, %f32Matrix* noalias nocapture) #0 {
entry:
  ...
  %16 = alloca { %f32Matrix*, i32 }, align 8
  %17 = bitcast { %f32Matrix*, i32 }* %16 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %17, align 8
  %18 = getelementptr inbounds { %f32Matrix*, i32 }, { %f32Matrix*, i32 }* %16, i64 0, i32 1
  store i32 0, i32* %18, align 8
  %19 = bitcast { %f32Matrix*, i32 }* %16 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, i32 }*, i64, i64)* @filter_2D_tmp_thunk0 to i8*), i8* %19, i64 %15) #0
  %pad-columns = sdiv i32 %9, 2
  %pad-rows = sdiv i32 %12, 2
  %20 = zext i32 %rows to i64
  %21 = alloca { %f32Matrix*, %f32Matrix*, i32, i32 }, align 8
  %22 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %21, i64 0, i32 0
  store %f32Matrix* %0, %f32Matrix** %22, align 8
  %23 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %21, i64 0, i32 1
  %24 = bitcast %f32Matrix** %23 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %24, align 8
  %25 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %21, i64 0, i32 2
  store i32 %pad-columns, i32* %25, align 8
  %26 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, i32, i32 }* %21, i64 0, i32 3
  store i32 %pad-rows, i32* %26, align 4
  %27 = bitcast { %f32Matrix*, %f32Matrix*, i32, i32 }* %21 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk1 to i8*), i8* %27, i64 %20) #0
  ...
  %30 = alloca { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }, align 8
  %31 = bitcast { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30 to %u0Matrix**
  store %u0Matrix* %28, %u0Matrix** %31, align 8
  %32 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 1
  %33 = bitcast %f32Matrix** %32 to %u0Matrix**
  store %u0Matrix* %14, %u0Matrix** %33, align 8
  %34 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 2
  store %f32Matrix* %1, %f32Matrix** %34, align 8
  %35 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 3
  store i32 %width, i32* %35, align 8
  %36 = getelementptr inbounds { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }, { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30, i64 0, i32 4
  store i32 %height, i32* %36, align 4
  %37 = bitcast { %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }* %30 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix*, %f32Matrix*, i32, i32 }*, i64, i64)* @filter_2D_tmp_thunk2 to i8*), i8* %37, i64 %29) #0
