...
true_entry:                                       ; preds = %y_body, %loop.backedge
  ...
  %8 = getelementptr %i16SXY, %i16SXY* %0, i64 0, i32 6, i64 %7
...
y_exit:                                           ; preds = %exit
  %12 = bitcast %i16SXY* %0 to i8*
  %13 = call i8* @likely_retain_mat(i8* %12)
  %14 = bitcast i8* %13 to %i16SXY*
  ret %i16SXY* %14

true_entry4:                                      ; preds = %true_entry, %true_entry4
  %15 = phi i32 [ %22, %true_entry4 ], [ %10, %true_entry ]
  %16 = phi i32 [ %., %true_entry4 ], [ %5, %true_entry ]
  %17 = phi i16 [ %element., %true_entry4 ], [ %9, %true_entry ]
  %18 = sext i32 %15 to i64
  %19 = add nuw nsw i64 %18, %4
  %20 = getelementptr %i16SXY, %i16SXY* %0, i64 0, i32 6, i64 %19
  %element = load i16, i16* %20, align 2, !llvm.mem.parallel_loop_access !1
  %21 = icmp slt i16 %element, %17
  %element. = select i1 %21, i16 %element, i16 %17
...
true_entry8:                                      ; preds = %exit5
  ...
  %27 = getelementptr %i16SXY, %i16SXY* %0, i64 0, i32 6, i64 %26
  %28 = load i16, i16* %27, align 2, !llvm.mem.parallel_loop_access !1
  store i16 %28, i16* %8, align 2, !llvm.mem.parallel_loop_access !1
  store i16 %9, i16* %27, align 2, !llvm.mem.parallel_loop_access !1
