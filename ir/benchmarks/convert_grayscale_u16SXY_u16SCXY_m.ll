...
y_body:                                           ; preds = %y_body, %entry
  ...
  %14 = getelementptr %u16Matrix, %u16Matrix* %6, i64 0, i32 6, i64 %13
  %15 = load i16, i16* %14, align 2, !llvm.mem.parallel_loop_access !1
  %16 = add nuw nsw i64 %10, 2
  %17 = getelementptr %u16Matrix, %u16Matrix* %6, i64 0, i32 6, i64 %16
...
define %u16Matrix* @convert_grayscale(%u16Matrix*) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %u16Matrix*, %u16Matrix* }*, i64, i64)* @convert_grayscale_tmp_thunk0 to i8*), i8* %8, i64 %4)
  ret %u16Matrix* %dst
}
