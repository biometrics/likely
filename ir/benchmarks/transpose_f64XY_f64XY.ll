...
define noalias %f64Matrix* @transpose(%f64Matrix* nocapture readonly) {
entry:
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %10 = getelementptr %f64Matrix, %f64Matrix* %0, i64 0, i32 6, i64 %9
  %11 = load double, double* %10, align 8, !llvm.mem.parallel_loop_access !1
  %12 = add nuw nsw i64 %x, %7
  %13 = getelementptr double, double* %6, i64 %12
  store double %11, double* %13, align 8, !llvm.mem.parallel_loop_access !1
