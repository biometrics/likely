...
then:                                             ; preds = %c_body, %end3
  %storemerge26 = phi i32 [ 0, %c_body ], [ %60, %end3 ]
  %16 = phi double [ 0x7FEFFFFFFFFFFFFF, %c_body ], [ %53, %end3 ]
  %17 = phi double [ 0xFFEFFFFFFFFFFFFF, %c_body ], [ %57, %end3 ]
  %18 = phi i32 [ 0, %c_body ], [ %52, %end3 ]
  %19 = phi i32 [ 0, %c_body ], [ %51, %end3 ]
  %20 = phi i32 [ 0, %c_body ], [ %56, %end3 ]
  %21 = phi i32 [ 0, %c_body ], [ %55, %end3 ]
...
then2:                                            ; preds = %then, %then2
  %storemerge125 = phi i32 [ 0, %then ], [ %58, %then2 ]
  %40 = phi double [ %16, %then ], [ %53, %then2 ]
  %41 = phi double [ %17, %then ], [ %57, %then2 ]
  %42 = phi i32 [ %18, %then ], [ %52, %then2 ]
  %43 = phi i32 [ %19, %then ], [ %51, %then2 ]
  %44 = phi i32 [ %20, %then ], [ %56, %then2 ]
  %45 = phi i32 [ %21, %then ], [ %55, %then2 ]
  ...
  br i1 %59, label %end3, label %then2
