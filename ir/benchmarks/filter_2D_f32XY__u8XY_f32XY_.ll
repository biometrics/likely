...
y_exit10:                                         ; preds = %y_body9
  %24 = call %u0CXYT* @likely_new(i32 24864, i32 1, i32 %columns, i32 %rows, i32 1, i8* null)
  %25 = getelementptr inbounds %u0CXYT, %u0CXYT* %24, i64 1
  %26 = bitcast %u0CXYT* %25 to float*
...
y_exit32:                                         ; preds = %x_exit35
  %dst = bitcast %u0CXYT* %24 to %f32XY*
  %37 = bitcast %u0CXYT* %14 to i8*
...
true_entry39:                                     ; preds = %loop38.preheader, %true_entry39
  ...
  %45 = getelementptr %f32XY, %f32XY* %1, i64 0, i32 6, i64 %44
