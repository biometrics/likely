...
true_entry:                                       ; preds = %c_body, %true_entry
  ...
  %18 = phi i32 [ %current-value., %true_entry ], [ 2147483647, %c_body ]
  %19 = phi i32 [ %., %true_entry ], [ 0, %c_body ]
  %20 = phi i32 [ %29, %true_entry ], [ -2147483648, %c_body ]
  %21 = phi i32 [ %28, %true_entry ], [ 0, %c_body ]
  %22 = sext i32 %17 to i64
  %23 = mul nuw nsw i64 %22, %5
  %24 = add nuw nsw i64 %23, %c
  %25 = getelementptr %i32CXY, %i32CXY* %0, i64 0, i32 6, i64 %24
  %current-value = load i32, i32* %25, align 4, !llvm.mem.parallel_loop_access !1
  %26 = icmp slt i32 %current-value, %18
  %. = select i1 %26, i32 %17, i32 %19
  %current-value. = select i1 %26, i32 %current-value, i32 %18
  %27 = icmp sgt i32 %current-value, %20
  %28 = select i1 %27, i32 %17, i32 %21
  %29 = select i1 %27, i32 %current-value, i32 %20
...
exit:                                             ; preds = %true_entry
  ...
  %33 = sitofp i32 %current-value. to double
