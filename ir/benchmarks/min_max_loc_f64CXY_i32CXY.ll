...
true_entry:                                       ; preds = %c_body, %true_entry
  ...
  %18 = phi i32 [ %.1, %true_entry ], [ 2147483647, %c_body ]
  %19 = phi i32 [ %., %true_entry ], [ 0, %c_body ]
  %20 = phi i32 [ %30, %true_entry ], [ -2147483648, %c_body ]
  ...
  %26 = load i32, i32* %25, align 4, !llvm.mem.parallel_loop_access !1
  %27 = icmp slt i32 %26, %18
  %. = select i1 %27, i32 %17, i32 %19
  %.1 = select i1 %27, i32 %26, i32 %18
  %28 = icmp sgt i32 %26, %20
  %29 = select i1 %28, i32 %17, i32 %21
  %30 = select i1 %28, i32 %26, i32 %20
