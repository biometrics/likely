...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %13 = load i8, i8* %12, align 1, !llvm.mem.parallel_loop_access !3
  %14 = add nuw nsw i64 %x, %10
  %15 = getelementptr %f32Matrix, %f32Matrix* %4, i64 0, i32 6, i64 %14
  %16 = uitofp i8 %13 to float
...
define %f32Matrix* @covariance(%u8Matrix*) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, i32 }*, i64, i64)* @covariance_tmp_thunk0 to i8*), i8* %8, i64 %4)
...
true_entry:                                       ; preds = %y_exit
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, float }*, i64, i64)* @covariance_tmp_thunk1 to i8*), i8* %26, i64 %4)
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %29 = alloca { %f32Matrix*, %u8Matrix* }, align 8
  %30 = bitcast { %f32Matrix*, %u8Matrix* }* %29 to %u0Matrix**
  store %u0Matrix* %27, %u0Matrix** %30, align 8
  %31 = getelementptr inbounds { %f32Matrix*, %u8Matrix* }, { %f32Matrix*, %u8Matrix* }* %29, i64 0, i32 1
  store %u8Matrix* %0, %u8Matrix** %31, align 8
  %32 = bitcast { %f32Matrix*, %u8Matrix* }* %29 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %u8Matrix* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %32, i64 %28)
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix* }*, i64, i64)* @covariance_tmp_thunk3 to i8*), i8* %37, i64 %28)
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix*, i32 }*, i64, i64)* @covariance_tmp_thunk4 to i8*), i8* %45, i64 %39)
