...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %16 = getelementptr %u8SXY, %u8SXY* %0, i64 0, i32 6, i64 %15
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %29 = alloca { %f32SXY*, %u8SXY* }, align 8
  %30 = bitcast { %f32SXY*, %u8SXY* }* %29 to %u0CXYT**
  store %u0CXYT* %27, %u0CXYT** %30, align 8
  %31 = getelementptr inbounds { %f32SXY*, %u8SXY* }, { %f32SXY*, %u8SXY* }* %29, i64 0, i32 1
  store %u8SXY* %0, %u8SXY** %31, align 8
  %32 = bitcast { %f32SXY*, %u8SXY* }* %29 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32SXY*, %u8SXY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %32, i64 %28)
