...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk2({ %f32SXY*, %u8SXY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %f32SXY*, %u8SXY* }, { %f32SXY*, %u8SXY* }* %0, i64 0, i32 0
  %4 = load %f32SXY*, %f32SXY** %3, align 8
  %5 = getelementptr inbounds { %f32SXY*, %u8SXY* }, { %f32SXY*, %u8SXY* }* %0, i64 0, i32 1
  ...
  %12 = getelementptr inbounds %u8SXY, %u8SXY* %6, i64 0, i32 3
...
entry:
  ...
  %15 = getelementptr inbounds %u8SXY, %u8SXY* %0, i64 0, i32 6, i64 0
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %23 = getelementptr %u8SXY, %u8SXY* %0, i64 0, i32 6, i64 %22
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %36 = alloca { %f32SXY*, %u8SXY* }, align 8
  %37 = bitcast { %f32SXY*, %u8SXY* }* %36 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %37, align 8
  %38 = getelementptr inbounds { %f32SXY*, %u8SXY* }, { %f32SXY*, %u8SXY* }* %36, i64 0, i32 1
  store %u8SXY* %0, %u8SXY** %38, align 8
  %39 = bitcast { %f32SXY*, %u8SXY* }* %36 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32SXY*, %u8SXY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %39, i64 %35)
