...
; Function Attrs: nounwind
define private void @fused_multiply_add_tmp_thunk0({ %f64CXY*, %f64CXY*, double, double }* noalias nocapture readonly, i64, i64) #0 {
entry:
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %24 = getelementptr %f64CXY, %f64CXY* %6, i64 0, i32 6, i64 %y
  %25 = load double, double* %24, align 8, !llvm.mem.parallel_loop_access !1
  %26 = fmul double %8, %25
  %27 = fadd double %10, %26
  %28 = getelementptr %f64CXY, %f64CXY* %4, i64 0, i32 6, i64 %y
  store double %27, double* %28, align 8, !llvm.mem.parallel_loop_access !1
