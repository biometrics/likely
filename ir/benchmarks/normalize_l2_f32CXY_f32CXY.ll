...
entry:
  ...
  %3 = mul i32 %combine.extract.trunc5, %combine.extract.trunc
...
then:                                             ; preds = %entry, %then
  ...
  %19 = call %u0CXYT* @likely_new(i32 28960, i32 %combine.extract.trunc, i32 %combine.extract.trunc5, i32 %rows, i32 1, i8* null)
  ...
  %30 = mul nuw nsw i64 %combine.extract.shift, %dst_c
  %31 = mul nuw nsw i64 %20, %30
  br label %y_body
