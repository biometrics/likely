...
define %f32Matrix* @multiply_add(%f32Matrix*, float, float) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %f32Matrix*, %f32Matrix*, float, float }*, i64, i64)* @multiply_add_tmp_thunk0 to i8*), i8* %13, i64 %7)
  ret %f32Matrix* %dst
}
