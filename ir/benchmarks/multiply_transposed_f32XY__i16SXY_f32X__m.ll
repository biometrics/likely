...
define private void @multiply_transposed_tmp_thunk0({ %f32XY*, %i16SXY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %f32XY*, %i16SXY* }, { %f32XY*, %i16SXY* }* %0, i64 0, i32 0
  %4 = load %f32XY*, %f32XY** %3, align 8
  %5 = getelementptr inbounds { %f32XY*, %i16SXY* }, { %f32XY*, %i16SXY* }* %0, i64 0, i32 1
...
y_body:                                           ; preds = %y_body, %entry
  ...
  %17 = getelementptr %i16SXY, %i16SXY* %6, i64 0, i32 6, i64 %y
...
entry:
  ...
  %6 = alloca { %f32XY*, %i16SXY* }, align 8
  %7 = bitcast { %f32XY*, %i16SXY* }* %6 to %u0CXYT**
  store %u0CXYT* %4, %u0CXYT** %7, align 8
  %8 = getelementptr inbounds { %f32XY*, %i16SXY* }, { %f32XY*, %i16SXY* }* %6, i64 0, i32 1
  store %i16SXY* %0, %i16SXY** %8, align 8
  %9 = bitcast { %f32XY*, %i16SXY* }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %i16SXY* }*, i64, i64)* @multiply_transposed_tmp_thunk0 to i8*), i8* %9, i64 %5)
