...
define %f32X* @average(%f32XY* nocapture readonly) {
entry:
...
true_entry:                                       ; preds = %y_exit
  ...
  %23 = alloca { %f32X*, float }, align 8
  %24 = bitcast { %f32X*, float }* %23 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %24, align 8
  %25 = getelementptr inbounds { %f32X*, float }, { %f32X*, float }* %23, i64 0, i32 1
  store float %22, float* %25, align 8
  %26 = bitcast { %f32X*, float }* %23 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32X*, float }*, i64, i64)* @average_tmp_thunk1 to i8*), i8* %26, i64 %4)
  br label %exit
