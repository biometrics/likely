...
entry:
  ...
  %7 = getelementptr { %f64CXY*, %u8SCXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %u8SCXY*, i32, i32, i64, i64, i64, i64 }* %0, i64 0, i32 2
...
then5:                                            ; preds = %then5.lr.ph, %end10
  ...
  %62 = add i64 %tmp12, %c
  %63 = getelementptr %u8SCXY, %u8SCXY* %6, i64 0, i32 6, i64 %62
  %64 = load i8, i8* %63, align 1, !llvm.mem.parallel_loop_access !0
