...
; Function Attrs: nounwind
define private void @min_max_loc_tmp_thunk0({ %f64CXY*, %u8SCXY*, i32, i32, i64, i64, i64, i64 }* noalias nocapture readonly, i64, i64) #0 {
entry:
...
then5:                                            ; preds = %then, %then5
  ...
  %58 = add i64 %tmp12, %c
  %59 = getelementptr %u8SCXY, %u8SCXY* %6, i64 0, i32 6, i64 %58
