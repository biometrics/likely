...
define %u16Matrix* @multiply_add(%u16Matrix*, float, float) {
entry:
  ...
  call void @likely_fork(i8* bitcast (void ({ %u16Matrix*, %u16Matrix*, float, float }*, i64, i64)* @multiply_add_tmp_thunk0 to i8*), i8* %13, i64 %7)
  ret %u16Matrix* %dst
}
