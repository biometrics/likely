...
true_entry:                                       ; preds = %c_body, %true_entry
  ...
  %25 = phi i32 [ %current-value., %true_entry ], [ 2147483647, %c_body ]
  %26 = phi i32 [ %., %true_entry ], [ 0, %c_body ]
  %27 = phi i32 [ %36, %true_entry ], [ -2147483648, %c_body ]
  %28 = phi i32 [ %35, %true_entry ], [ 0, %c_body ]
  %29 = sext i32 %24 to i64
  %30 = mul nuw nsw i64 %29, %dst_c
  %31 = add nuw nsw i64 %30, %c
  %32 = getelementptr %i32CXY, %i32CXY* %6, i64 0, i32 6, i64 %31
  %current-value = load i32, i32* %32, align 4, !llvm.mem.parallel_loop_access !1
  %33 = icmp slt i32 %current-value, %25
  %. = select i1 %33, i32 %24, i32 %26
  %current-value. = select i1 %33, i32 %current-value, i32 %25
  %34 = icmp sgt i32 %current-value, %27
  %35 = select i1 %34, i32 %24, i32 %28
  %36 = select i1 %34, i32 %current-value, i32 %27
  %37 = add nuw nsw i32 %24, 1
  %38 = icmp eq i32 %37, %21
  br i1 %38, label %exit, label %true_entry

exit:                                             ; preds = %true_entry, %c_body
  %.lcssa10 = phi i32 [ 2147483647, %c_body ], [ %current-value., %true_entry ]
  %.lcssa9 = phi i32 [ 0, %c_body ], [ %., %true_entry ]
  %.lcssa8 = phi i32 [ -2147483648, %c_body ], [ %36, %true_entry ]
  %.lcssa = phi i32 [ 0, %c_body ], [ %35, %true_entry ]
  %39 = getelementptr %f64CXY, %f64CXY* %4, i64 0, i32 6, i64 %c
  %40 = sitofp i32 %.lcssa10 to double
  ...
  %51 = sitofp i32 %.lcssa8 to double
...
entry:
  ...
  %3 = getelementptr inbounds %i32CXY, %i32CXY* %0, i64 0, i32 3
  ...
  %6 = alloca { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, align 8
  %7 = bitcast { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %7, align 8
  %8 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 1
  store %i32CXY* %0, %i32CXY** %8, align 8
  %9 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 2
  store i32 %width, i32* %9, align 8
  %10 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 3
  store i32 %height, i32* %10, align 4
  %11 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 4
  store i64 %5, i64* %11, align 8
  %12 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 5
  store i64 1, i64* %12, align 8
  %13 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 6
  store i64 1, i64* %13, align 8
  %14 = getelementptr inbounds { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }, { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6, i64 0, i32 7
  store i64 1, i64* %14, align 8
  %15 = bitcast { %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }* %6 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f64CXY*, %i32CXY*, i32, i32, i64, i64, i64, i64 }*, i64, i64)* @min_max_loc_tmp_thunk0 to i8*), i8* %15, i64 %5)
  ret %f64CXY* %dst
}
