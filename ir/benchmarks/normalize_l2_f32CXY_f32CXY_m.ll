...
then:                                             ; preds = %entry, %then
  ...
  %18 = bitcast %u0CXYT* %17 to %f32CXY*
  %19 = zext i32 %rows to i64
  %20 = alloca { %f32CXY*, %f32CXY*, double }, align 8
  %21 = bitcast { %f32CXY*, %f32CXY*, double }* %20 to %u0CXYT**
  store %u0CXYT* %17, %u0CXYT** %21, align 8
  %22 = getelementptr inbounds { %f32CXY*, %f32CXY*, double }, { %f32CXY*, %f32CXY*, double }* %20, i64 0, i32 1
  store %f32CXY* %0, %f32CXY** %22, align 8
  %23 = getelementptr inbounds { %f32CXY*, %f32CXY*, double }, { %f32CXY*, %f32CXY*, double }* %20, i64 0, i32 2
  store double %16, double* %23, align 8
  %24 = bitcast { %f32CXY*, %f32CXY*, double }* %20 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32CXY*, %f32CXY*, double }*, i64, i64)* @normalize_l2_tmp_thunk0 to i8*), i8* %24, i64 %19)
  ret %f32CXY* %18
}
