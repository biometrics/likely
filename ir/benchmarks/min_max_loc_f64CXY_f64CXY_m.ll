...
then:                                             ; preds = %c_body, %end6
  %27 = phi i32 [ %68, %end6 ], [ 0, %c_body ]
  %28 = phi i32 [ %69, %end6 ], [ 0, %c_body ]
  %29 = phi i32 [ %70, %end6 ], [ 0, %c_body ]
  %30 = phi i32 [ %71, %end6 ], [ 0, %c_body ]
  %31 = phi double [ %72, %end6 ], [ 0xFFEFFFFFFFFFFFFF, %c_body ]
  %32 = phi double [ %73, %end6 ], [ 0x7FEFFFFFFFFFFFFF, %c_body ]
  %33 = phi i32 [ %74, %end6 ], [ 0, %c_body ]
...
label.end_crit_edge:                              ; preds = %end6
  ...
  %38 = phi double [ %72, %label.end_crit_edge ], [ 0xFFEFFFFFFFFFFFFF, %c_body ]
  %39 = phi i32 [ %70, %label.end_crit_edge ], [ 0, %c_body ]
  %40 = phi i32 [ %71, %label.end_crit_edge ], [ 0, %c_body ]
  %41 = phi double [ %73, %label.end_crit_edge ], [ 0x7FEFFFFFFFFFFFFF, %c_body ]
...
then5:                                            ; preds = %then5.lr.ph, %end10
  %56 = phi i32 [ %27, %then5.lr.ph ], [ %80, %end10 ]
  %57 = phi i32 [ %28, %then5.lr.ph ], [ %81, %end10 ]
  %58 = phi i32 [ %29, %then5.lr.ph ], [ %76, %end10 ]
  %59 = phi i32 [ %30, %then5.lr.ph ], [ %77, %end10 ]
  %60 = phi double [ %31, %then5.lr.ph ], [ %82, %end10 ]
  %61 = phi double [ %32, %then5.lr.ph ], [ %78, %end10 ]
  %62 = phi i32 [ 0, %then5.lr.ph ], [ %83, %end10 ]
  ...
  br i1 %67, label %then7, label %end8

label4.end6_crit_edge:                            ; preds = %end10
  br label %end6

end6:                                             ; preds = %label4.end6_crit_edge, %then
  %68 = phi i32 [ %80, %label4.end6_crit_edge ], [ %27, %then ]
  %69 = phi i32 [ %81, %label4.end6_crit_edge ], [ %28, %then ]
  %70 = phi i32 [ %76, %label4.end6_crit_edge ], [ %29, %then ]
  %71 = phi i32 [ %77, %label4.end6_crit_edge ], [ %30, %then ]
  %72 = phi double [ %82, %label4.end6_crit_edge ], [ %31, %then ]
  %73 = phi double [ %78, %label4.end6_crit_edge ], [ %32, %then ]
  %74 = add nuw nsw i32 %33, 1
  %75 = icmp eq i32 %74, %10
  br i1 %75, label %label.end_crit_edge, label %then

then7:                                            ; preds = %then5
  br label %end8

end8:                                             ; preds = %then7, %then5
  %76 = phi i32 [ %33, %then7 ], [ %58, %then5 ]
  %77 = phi i32 [ %62, %then7 ], [ %59, %then5 ]
  %78 = phi double [ %66, %then7 ], [ %61, %then5 ]
  %79 = fcmp ogt double %66, %60
  br i1 %79, label %then9, label %end10

then9:                                            ; preds = %end8
  br label %end10

end10:                                            ; preds = %then9, %end8
  %80 = phi i32 [ %33, %then9 ], [ %56, %end8 ]
  %81 = phi i32 [ %62, %then9 ], [ %57, %end8 ]
  %82 = phi double [ %66, %then9 ], [ %60, %end8 ]
  %83 = add nuw nsw i32 %62, 1
  %84 = icmp eq i32 %83, %8
  br i1 %84, label %label4.end6_crit_edge, label %then5
}
