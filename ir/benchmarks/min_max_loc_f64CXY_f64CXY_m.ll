...
then:                                             ; preds = %c_body, %end6
  %25 = phi i32 [ %66, %end6 ], [ 0, %c_body ]
  %26 = phi i32 [ %67, %end6 ], [ 0, %c_body ]
  %27 = phi i32 [ %68, %end6 ], [ 0, %c_body ]
  %28 = phi i32 [ %69, %end6 ], [ 0, %c_body ]
  %29 = phi double [ %70, %end6 ], [ 0xFFEFFFFFFFFFFFFF, %c_body ]
  %30 = phi double [ %71, %end6 ], [ 0x7FEFFFFFFFFFFFFF, %c_body ]
  %31 = phi i32 [ %72, %end6 ], [ 0, %c_body ]
  br i1 %23, label %end6, label %then5.lr.ph

then5.lr.ph:                                      ; preds = %then
  %32 = sext i32 %31 to i64
  %33 = mul nsw i64 %32, %combine.extract.shift22
  br label %then5
...
label.end_crit_edge:                              ; preds = %end6
  ...
  %34 = phi i32 [ %66, %label.end_crit_edge ], [ 0, %c_body ]
  %35 = phi i32 [ %67, %label.end_crit_edge ], [ 0, %c_body ]
  %36 = phi double [ %70, %label.end_crit_edge ], [ 0xFFEFFFFFFFFFFFFF, %c_body ]
  %37 = phi i32 [ %68, %label.end_crit_edge ], [ 0, %c_body ]
  %38 = phi i32 [ %69, %label.end_crit_edge ], [ 0, %c_body ]
  %39 = phi double [ %71, %label.end_crit_edge ], [ 0x7FEFFFFFFFFFFFFF, %c_body ]
...
then5:                                            ; preds = %then5.lr.ph, %end10
  %54 = phi i32 [ %25, %then5.lr.ph ], [ %78, %end10 ]
  %55 = phi i32 [ %26, %then5.lr.ph ], [ %79, %end10 ]
  %56 = phi i32 [ %27, %then5.lr.ph ], [ %74, %end10 ]
  %57 = phi i32 [ %28, %then5.lr.ph ], [ %75, %end10 ]
  %58 = phi double [ %29, %then5.lr.ph ], [ %80, %end10 ]
  %59 = phi double [ %30, %then5.lr.ph ], [ %76, %end10 ]
...
end6:                                             ; preds = %label4.end6_crit_edge, %then
  %66 = phi i32 [ %78, %label4.end6_crit_edge ], [ %25, %then ]
  %67 = phi i32 [ %79, %label4.end6_crit_edge ], [ %26, %then ]
  %68 = phi i32 [ %74, %label4.end6_crit_edge ], [ %27, %then ]
  %69 = phi i32 [ %75, %label4.end6_crit_edge ], [ %28, %then ]
  %70 = phi double [ %80, %label4.end6_crit_edge ], [ %29, %then ]
  %71 = phi double [ %76, %label4.end6_crit_edge ], [ %30, %then ]
