...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk2({ %f32XY*, %i16XY*, %f32X* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  ...
  %15 = getelementptr inbounds %i16XY, %i16XY* %6, i64 0, i32 6, i64 0
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %36 = alloca { %f32XY*, %i16XY*, %f32X* }, align 8
  %37 = bitcast { %f32XY*, %i16XY*, %f32X* }* %36 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %37, align 8
  %38 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %36, i64 0, i32 1
  store %i16XY* %0, %i16XY** %38, align 8
  %39 = getelementptr inbounds { %f32XY*, %i16XY*, %f32X* }, { %f32XY*, %i16XY*, %f32X* }* %36, i64 0, i32 2
  %40 = bitcast %f32X** %39 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %40, align 8
  %41 = bitcast { %f32XY*, %i16XY*, %f32X* }* %36 to i8*
  call void @likely_fork(i8* bitcast (void ({ %f32XY*, %i16XY*, %f32X* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %41, i64 %35)
