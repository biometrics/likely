...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk2({ %i16XY*, %i16XY* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %23 = getelementptr %i16XY, %i16XY* %4, i64 0, i32 6, i64 %22
  store i16 %21, i16* %23, align 2, !llvm.mem.parallel_loop_access !3
  %x_increment = add nuw nsw i64 %x, 1
...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk3({ %i16XY*, %f32X* }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %i16XY*, %f32X* }, { %i16XY*, %f32X* }* %0, i64 0, i32 0
  %4 = load %i16XY*, %i16XY** %3, align 8
  %5 = getelementptr inbounds { %i16XY*, %f32X* }, { %i16XY*, %f32X* }* %0, i64 0, i32 1
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %18 = getelementptr %i16XY, %i16XY* %4, i64 0, i32 6, i64 %17
  %19 = load i16, i16* %18, align 2, !llvm.mem.parallel_loop_access !4
  ...
  store i16 %24, i16* %18, align 2, !llvm.mem.parallel_loop_access !4
  %x_increment = add nuw nsw i64 %x, 1
...
; Function Attrs: nounwind
define private void @covariance_tmp_thunk4({ %i16XY*, %i16XY*, i32 }* noalias nocapture readonly, i64, i64) #1 {
entry:
  %3 = getelementptr inbounds { %i16XY*, %i16XY*, i32 }, { %i16XY*, %i16XY*, i32 }* %0, i64 0, i32 0
  %4 = load %i16XY*, %i16XY** %3, align 8
  %5 = getelementptr inbounds { %i16XY*, %i16XY*, i32 }, { %i16XY*, %i16XY*, i32 }* %0, i64 0, i32 1
  %6 = load %i16XY*, %i16XY** %5, align 8
  %7 = getelementptr inbounds { %i16XY*, %i16XY*, i32 }, { %i16XY*, %i16XY*, i32 }* %0, i64 0, i32 2
  %8 = load i32, i32* %7, align 4
  %9 = getelementptr inbounds %i16XY, %i16XY* %6, i64 0, i32 3
  %columns1 = load i32, i32* %9, align 4, !range !2
  %dst_y_step = zext i32 %columns1 to i64
  %10 = getelementptr inbounds %i16XY, %i16XY* %4, i64 0, i32 6, i64 0
  %11 = ptrtoint i16* %10 to i64
  %12 = and i64 %11, 31
  %13 = icmp eq i64 %12, 0
  call void @llvm.assume(i1 %13)
  %14 = getelementptr inbounds %i16XY, %i16XY* %6, i64 0, i32 6, i64 0
...
true_entry3:                                      ; preds = %loop.preheader, %true_entry3
  ...
  %26 = getelementptr %i16XY, %i16XY* %6, i64 0, i32 6, i64 %25
  %27 = load i16, i16* %26, align 2, !llvm.mem.parallel_loop_access !5
  %28 = sitofp i16 %27 to double
  %29 = add nuw nsw i64 %24, %y
  %30 = getelementptr %i16XY, %i16XY* %6, i64 0, i32 6, i64 %29
  %31 = load i16, i16* %30, align 2, !llvm.mem.parallel_loop_access !5
...
exit4:                                            ; preds = %true_entry3, %loop.preheader
  ...
  %38 = getelementptr %i16XY, %i16XY* %4, i64 0, i32 6, i64 %37
  %39 = fptosi double %.lcssa to i16
  store i16 %39, i16* %38, align 2, !llvm.mem.parallel_loop_access !5
  %40 = mul nuw nsw i64 %x, %dst_y_step
  %41 = add nuw nsw i64 %40, %y
  %42 = getelementptr %i16XY, %i16XY* %4, i64 0, i32 6, i64 %41
  store i16 %39, i16* %42, align 2, !llvm.mem.parallel_loop_access !5
  br label %Flow6
}
...
exit:                                             ; preds = %y_exit, %true_entry
  ...
  %34 = call %u0CXYT* @likely_new(i32 25104, i32 1, i32 %columns7, i32 %rows8, i32 1, i8* null)
  %35 = zext i32 %rows8 to i64
  %36 = alloca { %i16XY*, %i16XY* }, align 8
  %37 = bitcast { %i16XY*, %i16XY* }* %36 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %37, align 8
  %38 = getelementptr inbounds { %i16XY*, %i16XY* }, { %i16XY*, %i16XY* }* %36, i64 0, i32 1
  store %i16XY* %0, %i16XY** %38, align 8
  %39 = bitcast { %i16XY*, %i16XY* }* %36 to i8*
  call void @likely_fork(i8* bitcast (void ({ %i16XY*, %i16XY* }*, i64, i64)* @covariance_tmp_thunk2 to i8*), i8* %39, i64 %35)
  %40 = alloca { %i16XY*, %f32X* }, align 8
  %41 = bitcast { %i16XY*, %f32X* }* %40 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %41, align 8
  %42 = getelementptr inbounds { %i16XY*, %f32X* }, { %i16XY*, %f32X* }* %40, i64 0, i32 1
  %43 = bitcast %f32X** %42 to %u0CXYT**
  store %u0CXYT* %2, %u0CXYT** %43, align 8
  %44 = bitcast { %i16XY*, %f32X* }* %40 to i8*
  call void @likely_fork(i8* bitcast (void ({ %i16XY*, %f32X* }*, i64, i64)* @covariance_tmp_thunk3 to i8*), i8* %44, i64 %35)
  %45 = call %u0CXYT* @likely_new(i32 25104, i32 1, i32 %columns7, i32 %columns7, i32 1, i8* null)
  %dst = bitcast %u0CXYT* %45 to %i16XY*
  %46 = zext i32 %columns7 to i64
  %47 = alloca { %i16XY*, %i16XY*, i32 }, align 8
  %48 = bitcast { %i16XY*, %i16XY*, i32 }* %47 to %u0CXYT**
  store %u0CXYT* %45, %u0CXYT** %48, align 8
  %49 = getelementptr inbounds { %i16XY*, %i16XY*, i32 }, { %i16XY*, %i16XY*, i32 }* %47, i64 0, i32 1
  %50 = bitcast %i16XY** %49 to %u0CXYT**
  store %u0CXYT* %34, %u0CXYT** %50, align 8
  %51 = getelementptr inbounds { %i16XY*, %i16XY*, i32 }, { %i16XY*, %i16XY*, i32 }* %47, i64 0, i32 2
  store i32 %rows8, i32* %51, align 8
  %52 = bitcast { %i16XY*, %i16XY*, i32 }* %47 to i8*
  call void @likely_fork(i8* bitcast (void ({ %i16XY*, %i16XY*, i32 }*, i64, i64)* @covariance_tmp_thunk4 to i8*), i8* %52, i64 %46)
