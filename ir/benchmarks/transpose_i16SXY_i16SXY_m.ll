...
define private void @transpose_tmp_thunk0({ %u16Matrix*, %u16Matrix* }* noalias nocapture readonly, i64, i64) #1 {
entry:
...
entry.split:                                      ; preds = %entry
  ...
  %7 = getelementptr inbounds %u16Matrix, %u16Matrix* %6, i64 0, i32 4
...
x_body:                                           ; preds = %y_body, %x_body
  ...
  %15 = getelementptr %u16Matrix, %u16Matrix* %4, i64 0, i32 6, i64 %14
  store i16 %13, i16* %15, align 2, !llvm.mem.parallel_loop_access !1
...
define noalias %u16Matrix* @transpose(%u16Matrix* noalias nocapture) #2 {
entry:
  br label %entry.split
...
entry.split:                                      ; preds = %entry
  ...
  %3 = call %u0Matrix* @likely_new(i32 26128, i32 1, i32 %rows, i32 %columns, i32 1, i8* null)
  ...
  call void @likely_fork(i8* bitcast (void ({ %u16Matrix*, %u16Matrix* }*, i64, i64)* @transpose_tmp_thunk0 to i8*), i8* %8, i64 %4) #2
  ret %u16Matrix* %dst
}
